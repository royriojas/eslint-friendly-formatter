...
We use the gray color to show some info about the context where the error/warning happens. If for some reason you want to disable this [#2](#2) you can do it using an environment variable.
